...
class _LogPageState extends State<LogPage> {
  ...
  Future<void> _grab() async {
    setState(() => _out = '>> 读取 logcat...');
    final r = await PlatformBridge.runShell('logcat -d -t 100 ${_filter.text}');
  ...
  Widget build(BuildContext context) {
    return ToolPage(
      title: '日志',
      subtitle: '读取 logcat 或 Hook 捕获的应用内部日志。可输入过滤关键字。',
      icon: Icons.terminal,
      children: [
        Card(
          child: Padding(
            ...
            child: Column(children: [
              TextField(controller: _filter,
                ...
                decoration: const InputDecoration(hintText: '过滤关键字，如 TAG:xxx')),
